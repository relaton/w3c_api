...
module W3cApi
  class Hal
    ...
    def setup
      ...
      register.add_endpoint(
        id: :affiliation_participants_index,
        type: :index,
        url: "/affiliations/{id}/participants",
        model: Models::ParticipantIndex,
      )

      register.add_endpoint(
        id: :affiliation_participations_index,
        type: :index,
        url: "/affiliations/{id}/participations",
      ...
      register.add_endpoint(
        ...
        type: :index,
        url: "/ecosystems",
        model: Models::EcosystemIndex,
      )

      register.add_endpoint(
        id: :ecosystem_resource,
        type: :resource,
        url: "/ecosystems/{id}",
      ...
      register.add_endpoint(
        id: :ecosystem_evangelists_index,
        type: :index,
        url: "/ecosystems/{shortname}/evangelists",
        model: Models::EvangelistIndex,
      )

      register.add_endpoint(
        id: :ecosystem_groups_index,
        type: :index,
        url: "/ecosystems/{shortname}/groups",
        model: Models::GroupIndex,
      )

      register.add_endpoint(
        id: :ecosystem_member_organizations_index,
        type: :index,
        url: "/ecosystems/{shortname}/member-organizations",
        model: Models::AffiliationIndex,
      )
      ...
      register.add_endpoint(
        id: :group_specifications_index,
        type: :index,
        url: "/groups/{id}/specifications",
        model: Models::SpecificationIndex,
      )

      register.add_endpoint(
        id: :group_charters_index,
        type: :index,
        url: "/groups/{id}/charters",
        model: Models::CharterIndex,
      )

      register.add_endpoint(
        id: :group_users_index,
        type: :index,
        url: "/groups/{id}/users",
      ...
      register.add_endpoint(
        id: :group_chairs_index,
        type: :index,
        url: "/groups/{id}/chairs",
        model: Models::ChairIndex,
      )

      register.add_endpoint(
        id: :group_team_contacts_index,
        type: :index,
        url: "/groups/{id}/teamcontacts",
        model: Models::TeamContactIndex,
      )

      register.add_endpoint(
        id: :group_participations_index,
        type: :index,
        url: "/groups/{id}/participations",
        model: Models::ParticipationIndex,
      )
      ...
      register.add_endpoint(
        id: :participation_participants_index,
        type: :index,
        url: "/participations/{id}/participants",
        model: Models::ParticipantIndex,
      )
      ...
      register.add_endpoint(
        id: :serie_index,
        type: :index,
        url: "/specification-series",
        model: Models::SerieIndex,
      )

      register.add_endpoint(
        id: :serie_resource,
        type: :resource,
        url: "/specification-series/{shortname}",
        model: Models::Serie,
      )

      register.add_endpoint(
        id: :serie_specification_resource,
        type: :index,
        url: "/specification-series/{shortname}/specifications",
        model: Models::SpecificationIndex,
      )
      ...
      register.add_endpoint(
        id: :specification_resource,
        type: :resource,
        url: "/specifications/{shortname}",
        model: Models::Specification,
      )

      register.add_endpoint(
        id: :specification_resource_version_index,
        type: :index,
        url: "/specifications/{shortname}/versions",
      ...
      register.add_endpoint(
        ...
        type: :index,
        url: "/translations",
        model: Models::TranslationIndex,
      )

      register.add_endpoint(
        id: :translation_resource,
        type: :resource,
        url: "/translations/{id}",
      ...
      register.add_endpoint(
        id: :user_groups_index,
        type: :index,
        url: "/users/{hash}/groups",
        model: Models::GroupIndex,
      )
      ...
      register.add_endpoint(
        id: :user_affiliations_index,
        type: :index,
        url: "/users/{hash}/affiliations",
        model: Models::AffiliationIndex,
      )

      register.add_endpoint(
        id: :user_participations_index,
        type: :index,
        url: "/users/{hash}/participations",
        model: Models::ParticipationIndex,
      )

      register.add_endpoint(
        id: :user_chair_of_groups_index,
        type: :index,
        url: "/users/{hash}/chair-of-groups",
        model: Models::GroupIndex,
      )

      register.add_endpoint(
        id: :user_team_contact_of_groups_index,
        type: :index,
        url: "/users/{hash}/team-contact-of-groups",
        model: Models::GroupIndex,
      )

      register.add_endpoint(
        id: :user_specifications_index,
        type: :index,
        url: "/users/{hash}/specifications",
        model: Models::SpecificationIndex,
      )
    end
  end
