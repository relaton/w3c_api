...
RSpec.describe W3cApi::Cli do
  ...
  describe "specification commands" do
    ...
    before do
      ...
      allow(specification).to receive_messages(
        to_yaml: "---\nshortname: html5\ntitle: HTML5\n", to_json: '{"shortname":"html5","title":"HTML5"}',
      )
      allow(specifications).to receive_messages(
        to_yaml: "---\n- shortname: html5\n  title: HTML5\n", to_json: '[{"shortname":"html5","title":"HTML5"}]',
      )
      allow(versions).to receive_messages(
        to_yaml: "---\n- date: 2017-12-14\n  title: REC\n", to_json: '[{"date":"2017-12-14","title":"REC"}]',
      )
    end
  ...
  describe "group commands" do
    ...
    before do
      ...
      allow(group).to receive_messages(
        to_yaml: "---\nid: 109735\nname: Immersive Web Working Group\n", to_json: '{"id":109735,"name":"Immersive Web Working Group"}',
      )
      allow(groups).to receive_messages(
        to_yaml: "---\n- id: 109735\n  name: Immersive Web Working Group\n", to_json: '[{"id":109735,"name":"Immersive Web Working Group"}]',
      )
      ...
      allow(specifications).to receive_messages(
        to_yaml: "---\n- shortname: webxr\n  title: WebXR\n", to_json: '[{"shortname":"webxr","title":"WebXR"}]',
      )
    end
  ...
  describe "user commands" do
    ...
    before do
      ...
      allow(user).to receive_messages(
        to_yaml: "---\nid: f1ovb5rydm8s0go04oco0cgk0sow44w\nname: Jennifer Strickland\n", to_json: '{"id":"f1ovb5rydm8s0go04oco0cgk0sow44w","name":"Jennifer Strickland"}',
      )
      allow(groups).to receive_messages(
        to_yaml: "---\n- id: 109735\n  name: Immersive Web Working Group\n", to_json: '[{"id":109735,"name":"Immersive Web Working Group"}]',
      )
      ...
      allow(affiliations).to receive_messages(
        to_yaml: "---\n- id: 1092\n  name: MITRE Corporation\n", to_json: '[{"id":1092,"name":"MITRE Corporation"}]',
      )
    end
  ...
  describe "translation commands" do
    ...
    before do
      ...
      allow(translation).to receive_messages(
        to_yaml: "---\nid: 2\ntitle: Video Introduction in French\nlanguage: fr\n", to_json: '{"id":2,"title":"Video Introduction in French","language":"fr"}',
      )
      allow(translations).to receive_messages(
        to_yaml: "---\n- id: 2\n  title: Video Introduction in French\n", to_json: '[{"id":2,"title":"Video Introduction in French"}]',
      )
    end
  ...
  describe "ecosystem commands" do
    ...
    before do
      allow(W3cApi::Client).to receive(:new).and_return(client)
      allow(ecosystem).to receive_messages(
        to_yaml: "---\nshortname: data\nname: Data and knowledge\n", to_json: '{"shortname":"data","name":"Data and knowledge"}',
      )
      allow(ecosystems).to receive_messages(
        to_yaml: "---\n- shortname: data\n  name: Data and knowledge\n", to_json: '[{"shortname":"data","name":"Data and knowledge"}]',
      )
      allow(groups).to receive_messages(
        to_yaml: "---\n- id: 109736\n  name: Data Shapes Working Group\n", to_json: '[{"id":109736,"name":"Data Shapes Working Group"}]',
      )
    end
