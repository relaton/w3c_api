  ...
  describe 'specification commands' do
    ...
    describe '#fetch' do
      ...
      it 'outputs a single specification when shortname is provided' do
        ...
        expect { spec_command.invoke(:fetch, [], { shortname: 'html5' }) }.not_to raise_error
        expect($stdout.string).to include('shortname: html5')
      end
      ...
      it 'outputs specifications by status when status is provided' do
        ...
        expect { spec_command.invoke(:fetch, [], { status: 'Recommendation' }) }.not_to raise_error
        expect($stdout.string).to include('shortname: html5')
      end
    end
    ...
    describe '#versions' do
      ...
      it 'outputs versions of a specification' do
        ...
        expect { spec_command.invoke(:versions, [], { shortname: 'html5' }) }.not_to raise_error
  ...
  describe 'group commands' do
    ...
    describe '#fetch' do
      ...
      it 'outputs a single group when id is provided' do
        ...
        expect { group_command.invoke(:fetch, [], { id: 109_735 }) }.not_to raise_error
        expect($stdout.string).to include('name: Immersive Web Working Group')
      end
    ...
    describe '#users' do
      ...
      it 'outputs users of a group' do
        ...
        expect { group_command.invoke(:users, [], { id: 109_735 }) }.not_to raise_error
    ...
    describe '#specifications' do
      ...
      it 'outputs specifications of a group' do
        ...
        expect { group_command.invoke(:specifications, [], { id: 109_735 }) }.not_to raise_error
  ...
  describe 'user commands' do
    ...
    describe '#fetch' do
      ...
      it 'outputs a user when id is provided' do
        ...
        expect { user_command.invoke(:fetch, [], { id: 'f1ovb5rydm8s0go04oco0cgk0sow44w' }) }.not_to raise_error
      ...
      it 'outputs user as JSON with --format=json' do
        ...
        expect do
          user_command.invoke(:fetch, [], { id: 'f1ovb5rydm8s0go04oco0cgk0sow44w', format: 'json' })
    ...
    describe '#groups' do
      ...
      it 'outputs groups a user is a member of' do
        ...
        expect { user_command.invoke(:groups, [], { id: 'f1ovb5rydm8s0go04oco0cgk0sow44w' }) }.not_to raise_error
        expect($stdout.string).to include('name: Immersive Web Working Group')
      end
    end
    ...
    describe '#specifications' do
      ...
      it 'outputs specifications a user has contributed to' do
        ...
        expect do
          user_command.invoke(:specifications, [], { id: 'f1ovb5rydm8s0go04oco0cgk0sow44w' })
        end.not_to raise_error
        expect($stdout.string).to include('title: WebXR')
      end
    end
  ...
  describe 'translation commands' do
    ...
    describe '#fetch' do
      ...
      it 'outputs a single translation when id is provided' do
        ...
        expect { translation_command.invoke(:fetch, [], { id: 2 }) }.not_to raise_error
  ...
  describe 'ecosystem commands' do
    ...
    describe '#fetch' do
      ...
      it 'outputs a single ecosystem when shortname is provided' do
        ...
        expect { ecosystem_command.invoke(:fetch, [], { shortname: 'data' }) }.not_to raise_error
        expect($stdout.string).to include('name: Data and knowledge')
      end
    end
    ...
    describe '#groups' do
      ...
      it 'outputs groups in an ecosystem' do
        ...
        expect { ecosystem_command.invoke(:groups, [], { shortname: 'data' }) }.not_to raise_error
