...
RSpec.describe W3cApi::Models::GroupIndex do
  ...
  describe "API integration" do
    ...
    let(:mock_groups) do
      ...
      described_class.from_json(mock_data.to_json)
    end
    ...
    it "fetches all groups" do
      ...
      expect(client.groups).to be_a(described_class)
  ...
  describe "accessing elements" do
    it "allows accessing elements by index" do
      ...
      expect(groups.links.groups.first.href).to eql("https://api.w3.org/groups/tf/ab-liaisons-to-bod")
    end
