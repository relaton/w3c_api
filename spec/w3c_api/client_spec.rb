  ...
  describe "specifications", :vcr do
    describe "#specifications" do
      it "returns a list of specifications" do
        ...
        expect(specifications.class.name).to eql("W3cApi::Models::SpecificationIndex")
        expect(specifications.links.specifications).not_to be_empty
        expect(specifications.links.specifications.first.class.name).to eql("W3cApi::Models::SpecificationLink")
    ...
    describe "#specification" do
      ...
      it "raises a not found error for nonexistent specification" do
        VCR.use_cassette("specification_nonexistent") do
          expect do
            client.specification("nonexistent-specification")
          end.to raise_error(Lutaml::Hal::NotFoundError)
        end
      end
    end
    ...
    describe "#specification_versions" do
      it "returns versions of a specification" do
        VCR.use_cassette("specification_html5_versions") do
          ...
          expect(versions.links.spec_versions.first.class.name).to eql("W3cApi::Models::SpecVersionLink")
        end
      end
    end
    ...
    describe "#specification_version" do
      it "returns a specific version of a specification" do
        ...
        allow(client).to receive(:specification_version).with("html5",
                                                              "20171214").and_return(mock_version)
    ...
    describe "#series" do
      it "returns a list of series" do
        VCR.use_cassette("series_list") do
          ...
          expect(series.links.series.first.class.name).to eql("W3cApi::Models::SerieLink")
